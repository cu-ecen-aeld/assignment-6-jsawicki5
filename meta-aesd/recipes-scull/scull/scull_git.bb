...
do_install() {
    ...
    install -m 0755 ${THISDIR}/files/scull-start-stop ${D}${sysconfdir}/init.d/${INITSCRIPT_NAME}
    install -d ${D}/lib/modules/${KERNEL_VERSION}/extra
    install -m 0644 ${B}/scull.ko ${D}/lib/modules/${KERNEL_VERSION}/extra/scull.ko
}
